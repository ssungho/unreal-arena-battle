...
void AABStageGimmick::SpawnRewardBoxes()
{
	...
	{
		FTransform WorldSpawnLocation(GetActorLocation() + RewardBoxLocation.Value + FVector(0.0f, 0.0f, 30.0f));
		AABItemBox* RewardBoxActor = GetWorld()->SpawnActorDeferred<AABItemBox>(RewardBoxClass, WorldSpawnLocation);
		if (RewardBoxActor)
		{
